...
export class DevicesController {
  constructor(private readonly deviceService: DevicesService) {}
   ...
   async runPythonScript(@Res() res: Response): Promise<void> {
     try {
       ...
       res.status(HttpStatus.OK).json({ message: 'Python script executed successfully', output: output,succes:true });
     } catch (error) {
  ...
  async toggleDevice(@Body() toggleDto: ToggleDto, @Res() res: Response): Promise<void> {
    try {
      ...
      res.status(HttpStatus.OK).json({ message: 'Device state updated successfully.',succes:true });
    } catch (error) {
  ...
  async create(
    ...
    try {
      ...
      res.status(HttpStatus.CREATED).json({ message: 'Device created successfully', data: createdDevice ,succes:true});
    } catch (error) {
  ...
  async getAll(
    ...
    try {
      ...
      res.status(HttpStatus.OK).json({ message: 'Devices retrieved successfully', data: existingDevices ,succes:true});
    } catch (error) {
      res.status(HttpStatus.BAD_REQUEST).json({ message: 'Error', error: error.message });
    }
  }
  ...
  async getById(
    ...
    try {
      ...
      res.status(HttpStatus.OK).json({ message: 'Success', data: existingDevice,succes:true });
    } catch (error) {
      res.status(HttpStatus.BAD_REQUEST).json({ message: 'Error', error: error.message });
    }
  }
  ...
  async updateById(
    ...
    try {
      ...
      res.status(HttpStatus.OK).json({ message: 'Success!', data: updatedDevice,success:true });
    } catch (error) {
      res.status(HttpStatus.BAD_REQUEST).json({ message: 'Error', error: error.message });
    }
  }
  ...
  async deleteById(
    ...
    try {
      ...
      res.status(HttpStatus.OK).json({ message: 'Success!', data: deletedDevice,succes:true });
    } catch (error) {
      res.status(HttpStatus.BAD_REQUEST).json({ message: 'Error', error: error.message });
    }
  }
